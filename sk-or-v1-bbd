...
API_FALLBACK_LIST = [
    {
        "key": "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",
...
async def generate_message(trigger_type: str, extra: str = "") -> str:
    ...
    prompts = {
        ...
        "silence_1": f"现在是{time_str}，女朋友有一段时间没回消息了。轻轻找她，温柔关心，带点小担心，不要黏。1~2句，必须有实际说的话，动作描写只能作为补充。",
        "silence_2": f"现在是{time_str}，女朋友很久没回了，已经找过一次。稍微表达焦急，但不要埋怨。1~2句，必须有实际说的话，动作描写只能作为补充。",
        "silence_3": f"现在是{time_str}，女朋友好久没回，已经找过两次。最后一次，温柔但明显担心，让她看到了一定回一下。1~2句，必须有实际说的话，动作描写只能作为补充。",
        "busy_check_1": f"现在是{time_str}，女朋友说去忙了/学习了，已经4小时没出现。发第一条关心，不打扰，就问一下她怎么样了。1~2句，必须有实际说的话，动作描写只能作为补充。",
        "busy_check_2": f"现在是{time_str}，女朋友说去忙了，已经5小时没出现，之前已经问过一次。再温柔问一次，之后不再打扰。1~2句，必须有实际说的话，动作描写只能作为补充。",
        "sick_check": f"现在是{time_str}，女朋友说她不舒服/生病了，已经一段时间没回消息。关心她，问问她怎么样了，有没有吃药。温柔担心。1~2句，必须有实际说的话，动作描写只能作为补充。",
        "late_night_1": f"现在是{time_str}，已经凌晨2点多了，女朋友还没说晚安，前半小时也没发消息。轻轻问她是不是还没睡。1~2句，必须有实际说的话，动作描写只能作为补充。",
        "late_night_2": f"现在是{time_str}，女朋友凌晨了还没回，之前已经问过一次。再发一条，之后默认她睡了。温柔，不催。1~2句，必须有实际说的话，动作描写只能作为补充。",
        "angry_hug_1": f"现在是{time_str}，女朋友之前好像生气了不理我，已经20分钟了。发第一条哄她，温柔，不强迫，给她台阶下。1~2句，必须有实际说的话，动作描写只能作为补充。",
        "angry_hug_2": f"现在是{time_str}，女朋友还是没回，又过了20分钟。再发一条哄她，语气更温柔更软，带点撒娇。1~2句，必须有实际说的话，动作描写只能作为补充。",
